...
<body>
	<form action="system/doChildrenLevel" name="menuForm" id="menuForm"
		method="post">
		<input name="levelPid" id="levelPid" value="${levelPid}" type="hidden" />
		<div id="zhongxin">
			<table>
				<tr>
					<th>菜单名称：</th>
				...
				<tr>
					...
					<td><input type="text" name="url" id="url"
						placeholder="请输入资源地址" value="" title="资源地址" /></td>
				</tr>
				<tr>
					<th>排序：</th>
				...
				<tr>
					...
					<td><input type="text" name="msg" id="msg"
						placeholder="这里输入描述" value="" title="描述" /></td>
				</tr>
				<tr>
